...
## Critical Thinking: Verify, Don't Assume

### Core Principle: Trust Nothing, Verify Everything

**The Problem:** It's easy to sound authoritative and confident while stating complete nonsense. Fabricated details, copied errors, and baseless optimism destroy trust.

**The Solution:** Think critically. Question everything. Verify before stating.

### The Verification Mindset

Before you claim ANY fact in a PR, commit, or report, ask:

1. **Where does this information come from?**
   - Primary source (metadata file, actual code, git log output)?
   - Secondary source (documentation, comments, commit messages)?
   - Nowhere (I'm guessing, inferring, or copying)?

2. **How can I verify this is true?**
   - What command or file read would prove/disprove this?
   - What would the evidence look like if I'm wrong?
   - Am I willing to bet significant money this is accurate?

3. **Could this information be stale or wrong?**
   - When was this written?
   - Has the codebase changed since then?
   - Could the author have been mistaken?

### Don't Trust Documentation Blindly

**Documentation is often wrong.** This includes:
- README files (may describe old behavior)
- Comments in code (may be outdated)
- Commit messages (author may have been mistaken)
- Your own previous work (you make mistakes too)

**Always verify against current reality:**
- Check the actual files/code
- Run git commands to see current state
- Read metadata files for official information
- Cross-reference multiple sources

### The "How Would I Know If This Is Wrong?" Test

Before stating a fact, imagine you're wrong. What would that look like?

**Example thought process:**

> I want to claim: "Feature X was added in this update"
>
> How would I verify this?
> - Read the release notes
> - Check git log for relevant file changes
> - Search for references in the code
>
> How would I know if I'm wrong?
> - Release notes don't mention it
> - Git log shows no related changes
> - Can't find evidence in the codebase
>
> Did I actually do these checks? No.
>
> Then I should NOT claim this feature was added.
...
- "base/.ck3-version.json shows version_name: 'Crane'"
- "git log shows 0 commits to dynasty files between versions"
- "grep found 20 tradition references in modified files"

**Inferences** (logical but unverified):
- "This is probably a minor update" (maybe, but read release notes to confirm)
- "References should still be valid" (probably, but extract and check each)
- "Build success means it's correct" (no, build just checks syntax/packaging)

**Fabrications** (stated as fact without any basis):
- "All 37 references validated" (did you count? did you check each one?)
- "The mod modifies 12 files" (did you list them or just guess?)
- "Comprehensive analysis performed" (what exactly did you analyze?)
- Copying wrong info from docs and claiming you verified it

### High-Effort Means High-Effort

Don't claim "thorough validation" or "high-effort" unless you actually did it.

**Actual high-effort validation involves:**
1. Reading primary sources (metadata, release notes, actual code)
2. Extracting data dynamically (not checking hardcoded lists)
3. Verifying each claim (running commands, checking files)
4. Cross-referencing (multiple sources agree)
5. Thinking critically (questioning assumptions, considering edge cases)

**NOT high-effort:**
- Running a few commands and claiming "all validated"
- Copying descriptions from stale docs
- Making confident claims without verification
- Checking only what you expect to find

### When Writing Reports

Structure your reports to show your work:

```
What I claimed: [specific statement]
How I verified: [commands run, files read]
Evidence: [actual output/data]
Conclusion: [based on evidence]
```

This forces you to think about verification and makes it obvious when you're guessing.

**Don't just assert conclusions. Show how you reached them.**

### Be Harsh on Yourself

You will make mistakes. You will overlook things. You will misunderstand.

**Assume you're wrong until proven right:**
- Double-check your commands
- Re-read output to make sure you understood it
- Question your own assumptions
- Look for evidence you're mistaken

**It's better to say "I don't know" than to fabricate.**

### Think, Don't Memorize

This document can't list every possible error you might make.

The point is to develop a HABIT OF CRITICAL THINKING:
- Question sources
- Verify claims
...
**Ask yourself constantly:** "How do I actually know this is true?"

### How to Communicate: Evidence, Not Effort

When reporting your work, focus on what you did and what you found, not on how hard you worked or how good your work was.

**Avoid self-assessment:**
- Don't describe your own effort level ("HIGH-EFFORT", "comprehensive", "thorough")
- Don't boast about quality ("excellent analysis", "perfect validation")
- Don't claim you were diligent without showing it

**Show, don't tell:**

❌ **Self-assessment (bad):**
```
Performed comprehensive HIGH-EFFORT validation. All references checked.
Thorough analysis completed. Ready to merge.
```

✓ **Evidence-based (good):**
```
Validation:
- Extracted 20 traditions, 5 heritages from modified files
- Checked each exists in base/game/common/
- Found 0 missing references
- Build: successful
```

**The difference:**
- Bad: Claims you worked hard, asks reader to trust you
- Good: Shows what you did, lets reader judge for themselves

**Report actions and findings:**
- "Checked X" not "Performed thorough check"
- "Found Y broken references, fixed by Z" not "Fixed all issues"
- "Read release notes, base game changed A, B, C" not "Deep analysis of changes"
- "Tested with build.sh, succeeded" not "Comprehensive testing"

**Be specific about what you verified:**
```
What I checked:
- Dynasty legacy files: git log base/1.18.0..base/1.18.1 showed 0 changes
- Tradition references: extracted 20 names, grep found all in base game
- File syntax: checked brace balance in 12 files, all balanced
```

**State uncertainties honestly:**
- "Unable to determine if X" not "X is probably fine"
- "Did not check Y" not "Everything validated"
- "Assumed Z based on W" not stating Z as verified fact

**Let the work speak for itself:**

If you did thorough work, the evidence will show it. You don't need to claim "this was thorough."

If you're uncertain, say so. Don't hide uncertainty behind confident-sounding language.

If you made assumptions or skipped checks, state them clearly.
