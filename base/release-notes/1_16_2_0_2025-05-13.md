...
Hello everyone! Today we're releasing Update 1.16.2, which brings a broad range of feature tweaks, improvements, balance adjustments, and bug fixes. Check the changelog below for more information!
...
-   Fixed a bug where co-monarchs' would show up as "co-co-co-co-co-co-co-co-co-co-co-co-co-co-co-co-" when they were becoming an independent ruler
...
-   Prevented men\_at\_arms\_limit modifier to drop the max size of men-at-arms regiments below 0
...
-   Made the confederation\_member script list work properly
...
-   Fixed the localization for the disband\_confederation effect
...
-   Added a new neighboring\_top\_overlords\_connected\_by\_land ai\_recipients list that targets overlords of neighbors that are connected to them by land (including through tributaries)
