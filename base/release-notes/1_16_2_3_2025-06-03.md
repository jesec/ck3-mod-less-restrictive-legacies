...
Hello everyone! Today we're releasing a small update to resolve a stability issue in addition to some other issues. This update should be fully compatible with existing saves, as well as most mods compatible with 1.16.
...
-   We’ve exposed the trigger for fertility equilibrium and made it possible to set HERD\_GAIN\_FROM\_COUNTY\_MULTIPLIER to 0
