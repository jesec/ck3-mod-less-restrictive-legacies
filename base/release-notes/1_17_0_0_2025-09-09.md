...
It is your time to step up as a ruler! Key Features:
...
Fixed travel\_danger\_events.6000 listing the wrong character in its effects and hunt\_legendary\_animal\_custom\_loc\_trigger no longer errors if scoped on the root character.
...
Makes holy\_site\_unique background include generic fallback backgrounds
